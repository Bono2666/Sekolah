...
@section('content')
    <div class="col-12">
        <form method="PUT" action="{{ route('roles.edit', $data[0]->id) }}">
            @csrf
            ...
            <div class="card">    
                <div class="card-body">
                    <div class="form-group mb-1">
                        ...
                        <input value="{{ $data[0]->nama_role }}" type="text" id="nama_role" name="nama_role" class="form-control" style="width: 20%" required autofocus>
                    </div>
                    <div class="form-group mb-3">
                        <label for="menu" class="label">Menu:*</label>
                        <select class="custom-select" name="menu" id="menu" style="width: 28%" required>
                            <option value={{ $data[0]->menu }}>{{ $data[0]->menu_desc }}
                    ...
                    <div class="form-check">
                        @if ($data[0]->tambah == 1)
                            <input type="checkbox" class="form-check-input" id="tambah" name="tambah" value=1 checked>
                        @else
                    ...
                    <div class="form-check">
                        @if ($data[0]->edit == 1)
                            <input type="checkbox" class="form-check-input" id="edit" name="edit" value=1 checked>
                        @else
